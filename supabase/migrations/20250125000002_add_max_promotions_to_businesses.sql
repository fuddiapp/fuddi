...
ADD COLUMN IF NOT EXISTS max_promotions INTEGER DEFAULT 10;
...
-- Los negocios que ya tienen más de 10 promociones mantendrán su límite alto
UPDATE businesses 
SET max_promotions = GREATEST(10, (
