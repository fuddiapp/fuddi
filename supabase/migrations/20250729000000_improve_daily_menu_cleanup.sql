-- Mejorar la limpieza automática de menús del día
-- Esta migración implementa un sistema robusto de limpieza automática

-- 1. Mejorar la función principal de limpieza
...
-- 2. Función para verificar el estado de limpieza
...
-- 3. Función para limpiar manualmente (para uso desde el frontend)
...
-- 4. Función para obtener solo menús vigentes (mejorada)
...
-- 5. Función para obtener solo reservas vigentes
...
-- 7. Comentarios para documentar las funciones
...
-- 8. Políticas RLS para permitir acceso a las funciones
-- Nota: Las funciones ya tienen SECURITY DEFINER, por lo que no necesitan políticas RLS adicionales 